...
<?php 
	...
	$curl->get(REST_ENDPOINT.'Events/item', array(
        ...
        <div class="row">
            ...
            <div class="col-md-9 col-sm-9">
                ...
                <section class="event-detail newsection">
                    <h2 class="main-title "><a href="#"><?php echo $details->Subject ?></a></h2>
                    <!-- meta -->
                    <ul class="meta clearfix">
                        <li class="date"><i class="icon fa fa-calendar"></i> <?php echo $details->StartTime ?></li>
                        <li><a href="#"><i class="icon fa fa-home"></i> Grand Hotel Califonria</a></li>
                        <li><a href="#"><i class="icon fa fa-map-marker"></i><?php echo $details->Location ?></a></li>
                    </ul>
                    <!-- event-detail-img -->
